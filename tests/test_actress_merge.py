...
def test_alice_merge_three_aliases_one_canonical():
    ...
    records = [
        {"name": "Alice Smith", "otherNames": ["Alice", "앨리스"], "lastModified": 100, "favorite": True,
         "debut": 2002, "height": 160},
        # 같은 사람을 다른 record 에서 부분 표기
        {"name": "Alice",       "otherNames": [],               "lastModified": 50,  "favorite": False,
         "debut": 2003},
        {"name": "앨리스",       "otherNames": ["Alice Smith"],  "lastModified": 80,  "favorite": False,
         "debut": 2002, "comment": "한국어 표기"},
        # 무관한 다른 사람
